...
import { Button, Container, Box, useColorMode, Input, FormControl, FormLabel, Text, Textarea } from "@chakra-ui/react";
						...
						<Box w={{ base: "80%", sm: 400 }} my={10} data-aos="fade-up" data-aos-duration="500" data-aos-delay="0">
							...
							<form onSubmit={handleSubmit}>
								...
								<FormControl id="message">
									...
									<Textarea bg={"white"} color={"black"} name="message" maxH={64} />
